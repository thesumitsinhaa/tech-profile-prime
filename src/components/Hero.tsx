...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary via-secondary to-primary animate-fade-in">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="pt-12 animate-float">
            <a href="#about" className="inline-block text-white/60 hover:text-white transition-colors">
